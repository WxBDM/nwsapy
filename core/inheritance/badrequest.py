...
class AlertError(BaseBadRequest):
    ...
    Attributes:
        type: A URI reference (RFC3986) that identifes the problem type.
        title: A short, human-readable summary of the problem type.
        status: The HTTP status code (RFC7231, Section 6) generated by the origin server 
            for this occurrence of the problem. 
            Minimum: 100, Max 999
        detail: A human-readable explaination specific to this occurance of the problem.
        instance: A URI reference that identifies the specific occurence of the problem.
        correlationId: A unique identifier for the request, used for NWS debugging purposes.
            Please include this identifier with any correspondence to help the API 
            maintainers investigate your issue.

    :param BaseBadRequest: Base class for all request error objects.
    :type BaseBadRequest: nwsapy.core.inheritance.BadBaseRequest
    """
    def __init__(self, response):
